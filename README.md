...
## 🎯 Questions
- What is the total number of transactions/customers represented in the dashboard?
- What is the aggregate credit score value shown in the KPI card?
- Why might total credit score be useful in a fraud analysis context?
- Which countries appear to have the highest concentration of transactions?
- Which device type has the highest number of fraud cases?
## 🎯 Objectives
- Perform exploratory data analysis (EDA).
- Identify trends and patterns in fraudulent transactions.
...
- Certain merchant categories and payment methods are more vulnerable to fraud.
- Customer credit score and account history provide valuable fraud indicators.
...
- Github: https://github.com/jayasree0323
